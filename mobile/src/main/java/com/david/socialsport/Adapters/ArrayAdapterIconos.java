...
public class ArrayAdapterIconos extends ArrayAdapter<String> {

    private List<Integer> images;

    public ArrayAdapterIconos(Context context, List<String> items, List<Integer> images) {
        super(context, android.R.layout.select_dialog_item, items);
        this.images = images;
    }

    public ArrayAdapterIconos(Context context, String[] items, Integer[] images) {
        super(context, android.R.layout.select_dialog_item, items);
        this.images = Arrays.asList(images);
    }

    public ArrayAdapterIconos(Context context, int items, int images) {
