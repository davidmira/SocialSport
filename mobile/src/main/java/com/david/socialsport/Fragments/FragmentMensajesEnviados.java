...
import com.david.socialsport.Adapters.AdapterMensajesPersonalesEnviados;
...
public class FragmentMensajesEnviados  extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    AdapterMensajesPersonalesEnviados adapter;
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container, Bundle savedInstanceState) {
        adapter = new AdapterMensajesPersonalesEnviados(getContext(), savedInstanceState);
    ...
    public void onRefresh() {
        ...
        miReferencia.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Map<String, Object> mensajesId = dataSnapshot.child("usuario").child(userID).child("mensaje").child("enviado").getValue(t);
