    ...
    private void inicializarFacebook() {
        ...
        botonIniciarSesionFacebook.registerCallback(manejadorDeLlamadasFacebook, new FacebookCallback<LoginResult>() {
            ...
            public void onCancel() {
                Toast.makeText(Login2.this, "Usuario canceló inicio de sesión con Facebook.", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onError(FacebookException error) {
                Toast.makeText(Login2.this, "Hubo un error al iniciar sesión con Facebook.", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        listenerAutenticacion = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (usuario != null) {
                    ...
                    finish();
                    startActivity(new Intent(Login2.this, Principal.class));
                    Toast.makeText(Login2.this, "Usuario: " + usuario.getEmail(), Toast.LENGTH_SHORT).show();
                } else {
                    /**
                     * El usuario aún no ha iniciado sesión.
                     */
                    Toast.makeText(Login2.this, "Usuario sin sesión", Toast.LENGTH_SHORT).show();
                }
            }
        };
    }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (!task.isSuccessful()) {
                             ...
                             */
                            Toast.makeText(Login2.this, "Falló la autenticación.", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (!task.isSuccessful()) {
                             ...
                             */
                            Toast.makeText(Login2.this, "Hubo un error.", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
